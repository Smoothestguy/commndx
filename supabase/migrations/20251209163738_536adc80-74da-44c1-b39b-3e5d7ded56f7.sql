-- Update the trigger function to properly handle status reversion and auto-close
...
BEGIN
  ...
  ELSE
    -- No billing - revert to 'sent' status (assuming PO was previously sent)
    v_new_status := 'sent';
  END IF;
