...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const editUrl = `${siteUrl}/apply/edit/${editToken}`;
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #ffffff; padding: 30px 20px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${editUrl}" style="display: inline-block; background: #f97316; color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Update My Application</a>
            </div>
            ...
            <p style="color: #9ca3af; font-size: 12px; margin-bottom: 0;">
              ...
              <a href="${editUrl}" style="color: #f97316;">${editUrl}</a>
            </p>
          </div>
        </body>
        </html>
