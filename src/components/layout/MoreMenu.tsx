import { Users, Package, ShoppingCart, Settings, UserCog, LogOut, X, Clock, UserCheck, IdCard, Link2, Receipt } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              {(isAdmin || isManager) && (
                <Button
                  variant="ghost"
                  className="w-full justify-start"
                  onClick={() => handleNavigation("/project-assignments")}
                >
