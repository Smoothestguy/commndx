...
import { useDeletePersonnel, useToggleDoNotHire } from "@/integrations/supabase/hooks/usePersonnel";
...
export function PersonnelTable({
  ...
  const allSelected = personnel.length > 0 && selectedIds.length === personnel.length;
  const someSelected = selectedIds.length > 0 && selectedIds.length < personnel.length;
    ...
    <div className="space-y-4">
      ...
      {selectionMode && selectedIds.length > 0 && (
        <div className="flex items-center gap-4 p-3 bg-muted rounded-lg">
          ...
          <Button size="sm" onClick={onPrintBadges}>
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => navigate(`/personnel/${person.id}?edit=true`)}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          className={person.status === "do_not_hire" ? "" : "text-destructive"}
                        >
