...
export function ApplicationDetailDialog({
  ...
  const formResponses = useMemo(() => {
    ...
    const answers = application.answers as Record<string, unknown>;
    const responses: { label: string; value: string; type: string; isImage: boolean }[] = [];

    for (const [fieldId, value] of Object.entries(answers)) {
      const fieldInfo = fieldLabelMap[fieldId] || { label: fieldId, type: "text" };
      let displayValue = "";
      let isImage = false;
        ...
        <DialogHeader className="flex-shrink-0">
          <div className="flex items-center justify-between">
            <div>
              ...
              <DialogDescription>
                Review application from {applicant?.first_name} {applicant?.last_name}
              </DialogDescription>
            </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex-1 space-y-3">
                {isEditing ? (
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      <Label className="text-xs text-muted-foreground">Home ZIP</Label>
                      <Input
            ...
            {formResponses.length > 0 && (
              <div className="space-y-3">
                <Label className="text-muted-foreground text-sm">Form Responses</Label>
        ...
        <DialogFooter className="flex-shrink-0 pt-4 border-t">
          {isEditing ? (
            <div className="flex gap-2 w-full justify-end">
              ...
              <Button onClick={handleSaveEdit} disabled={updateApplicant.isPending}>
